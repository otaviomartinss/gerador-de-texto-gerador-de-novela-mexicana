...
def gera_elenco(num_protag, num_viloes, num_coadjuvantes, num_ep):
    i = 0
...
def gera_eps(num_ep):
    ...
    while n < num_ep:
        ...
        for i in protagonistas:
            ...
            coad = coadjuvantes[randint(0, len(coadjuvantes)-1)]
        ...
        for i in viloes:
            acao = acoes[randint(0, len(acoes)-1)]
            prot = protagonistas[randint(0, len(protagonistas)-1)]
            loc = locais[randint(0, len(locais)-1)]
        ...
        for i in protagonistas:
            acao = acoes[randint(0, len(acoes)-1)]
            vil = viloes[randint(0, len(viloes)-1)]
            loc = locais[randint(0, len(locais)-1)]
